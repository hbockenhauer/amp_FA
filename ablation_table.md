...
| ID | Config | PointPainting (ResNet) | Doppler Cluster | Doppler Attention | Temporal (5 frames) | Neck Refine | Wide PFN | mAP |
|----|--------|:----------------------:|:---------------:|:-----------------:|:-------------------:|:-----------:|:--------:|-----|
...
| A7 | `pointPainting_resnet_temporal_5frames_doppler_neck_wide_pfn` | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | |
